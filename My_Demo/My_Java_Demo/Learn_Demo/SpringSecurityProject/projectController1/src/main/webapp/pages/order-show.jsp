				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								memberId="datepicker-a3" readonly="readonly"
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								memberId="datepicker-a6" value="${order.product.departureTimeStr}"
								readonly="readonly">
						</div>
					</div>
					...
					<tbody>
						<c:forEach var="traveller" items="${order.travellerList}">
							...
							<tr>
								...
								<td><input type="text" size="10" value="${traveller.travellerType}" readonly="readonly"></td>
								...
								<td><input type="text" size="15" value="${traveller.credentialsType}" readonly="readonly"></td>
