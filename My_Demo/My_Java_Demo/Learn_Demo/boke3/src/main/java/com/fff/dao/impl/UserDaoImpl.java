...
import com.fff.utils.MybatisUtil;
...
//        sqlSession.close();
        ...
        IUserDao userDao = MybatisUtil.getDao(IUserDao.class);
...
//            加载主配置文件，获得数据库连接数据，
            ...
            int update = sqlSession.update("com.fff.dao.IUserDao.updateUserByUser", user);
