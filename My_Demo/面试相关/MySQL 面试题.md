...
6. 是否需要外键支持。
   ...
   > ：目前开发已经不考虑外链，主要原因是性能。具体可以看看 [《从 MySQL 物理外键开始的思考》](http://www.justabug.net/think-in-mysql-foreign-key/) 文章。
...
解释 MySQL 索引的原理，篇幅会比较长，并且网络上已经有靠谱的资料可以看，所以这里整理了几篇，胖友可以对照着看。
...
再另外，可能有胖友有和的一样疑惑，在**辅助索引**如果相同的索引怎么存储？最终存储到 B+Tree 非子节点中时，它们对应的主键 ID 是不同的，所以妥妥的。如下图所示：![相同的索引怎么存储](http://www.iocoder.cn/images/MySQL/2019_12_01/01.png)
...
> ：注意，我们上面看到的都是 InnoDB 存储引擎下的索引实现。
...
![主键索引](http://static.iocoder.cn/d49d260fc1eb8f992df0401b70d70e3d)
...
![辅助索引](http://static.iocoder.cn/2fb922405a35479fa99eb2de4708638c)
...
![事务的特性](http://www.iocoder.cn/images/Spring/2018-12-24/06.png)
...
具体的，可以看看 [《SQL 查询之执行顺序解析》](http://zouzls.github.io/2017/03/23/SQL%E6%9F%A5%E8%AF%A2%E4%B9%8B%E6%89%A7%E8%A1%8C%E9%A1%BA%E5%BA%8F%E8%A7%A3%E6%9E%90/) 文章。
...
不过这时候也不能就是断定他不懂 MySQL 高可用，也许是没有实际机会去使用，那么我就要问 [MMM](http://www.cnblogs.com/gomysql/p/3671896.html) 以及 [MHA](http://svip.iocoder.cn/MySQL/Interview/MySQL%E9%AB%98%E5%8F%AF%E7%94%A8%E6%9E%B6%E6%9E%84%E4%B9%8BMHA) 以及 [MM + keepalived](http://blog.51cto.com/sumongodb/1953244) 等的原理、实现方式以及它们之间的优势和不足了，一般这种情况下，能说出这个的基本没有。
...
T T 知识点真多，胖友还是重点掌握文初说的几个，不要方，我们能赢。如下是在网络上找到过的一个 MySQL 问题清单（研发向）：
